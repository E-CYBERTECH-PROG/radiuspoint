...
!function(e, t) {
    ...
    const ge = ["input", "file", "range", "select", "radio", "checkbox", "textarea"]
      ...
      , Ee = {};
    Ee.text = Ee.email = Ee.password = Ee.number = Ee.tel = Ee.url = Ee.search = Ee.date = Ee["datetime-local"] = Ee.time = Ee.week = Ee.month = (e, t) => (Ae(e, t.inputValue),
    we(e, e, t),
    ve(e, t),
    e.type = t.input,
    e),
    Ee.file = (e, t) => (we(e, e, t),
    ve(e, t),
    e),
    Ee.range = (e, t) => {
    ...
    Ee.checkbox = (e, t) => {
        ...
        return q(o, t.inputPlaceholder || t.inputLabel),
        n
    }
    ,
    Ee.textarea = (e, t) => {
    ...
    const zt = {
      ...
      , tn = e => {
        ...
        e.theme && !["light", "dark", "auto", "minimal", "borderless", "embed-iframe", "bulma", "bulma-light", "bulma-dark"].includes(e.theme) && u(`Invalid theme "${e.theme}"`);
        for (const t in e)
            Gt(t),
            e.toast && Qt(t),
            en(t)
    ...
    const zn = (e, t, n) => new Promise( (i, s) => {
        ...
        ( (e, t, n) => { 
            We(e),
            t.toast || (e.keydownHandler = e => Ze(t, e, n),
