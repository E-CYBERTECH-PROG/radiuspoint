<section>
    ...
    <x-danger-button data-bs-toggle="modal" data-bs-target="#modal-confirm-user-deletion">{{ __('Delete Account') }}</x-danger-button>
    ...
    <x-modal name="confirm-user-deletion" :show="$errors->userDeletion->isNotEmpty()">
        <form method="post" action="{{ route('profile.destroy') }}">
            ...
            <div class="modal-body">
                <h2 class="mb-1">{{ __('Are you sure you want to delete your account?') }}</h2>
