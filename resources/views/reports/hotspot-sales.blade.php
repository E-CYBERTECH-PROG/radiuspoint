<x-sidebar-layout title="Hotspot Service Sales">
    ...
    <form method="GET">
        <div class="card">
            <div class="card-body d-flex flex-wrap align-items-center justify-content-between gap-3 border-bottom">
                <div class="d-flex align-items-center gap-2">
                    ...
                    <button type="button" class="btn btn-icon" data-bs-toggle="offcanvas" data-bs-target="#offcanvas-filters-hotspot-sales" title="Filters">
                    ...
                    @empty
                        <tr>
                            <td colspan="5" class="text-center py-5">
                                ...
                                <p class="text-uppercase text-muted small mb-1">No hotspot service sales matched yet.</p>
        ...
        <x-filter-modal name="hotspot-sales" :clear-url="route('reports.hotspot-sales')">
